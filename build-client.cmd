...
SET DEFINES=/D _WIN32_WINNT=0x06000 /D UNICODE /D _UNICODE /D BUILD_STATIC /D _STDC_FORMAT_MACROS /D VK_USE_PLATFORM_WIN32_KHR /D VK_PROTOTYPES /D ENABLE_TASK_PROFILER=0
SET CPPFLAGS=%INCLUDES% /FC /nologo /W4 /WX /wd4505 /Zi /EHsc /Ox
SET LIBRARIES=User32.lib Gdi32.lib Shell32.lib Advapi32.lib winmm.lib %VULKAN_SDK%\Source\lib\vulkan-1.lib
