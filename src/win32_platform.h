...
struct WIN32_ASYNC_TASK_SCHEDULER;                 /// See win32_scheduler.cc
struct WIN32_COMPUTE_TASK_SCHEDULER;               /// See win32_scheduler.cc
...
struct WIN32_THREAD_ARGS
{
    ...
    WIN32_ASYNC_TASK_SCHEDULER   *AsyncScheduler;  /// The system asynchronous long-running task scheduler.
    WIN32_COMPUTE_TASK_SCHEDULER *TaskScheduler;   /// The system non-blocking, compute-oriented task scheduler.
};
